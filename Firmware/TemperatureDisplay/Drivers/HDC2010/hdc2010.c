...
void hdc2010_init(void) {
    ...
    HAL_I2C_Mem_Write_DMA(&HDC2010_I2C_PORT, HDC2010_ADDR, HDC2010_RESET_INT_CONF, I2C_MEMADD_SIZE_8BIT, (uint8_t[]) {0x50}, 1);
    ...
    HAL_I2C_Mem_Write_DMA(&HDC2010_I2C_PORT, HDC2010_ADDR, HDC2010_MEASURE_CONF, I2C_MEMADD_SIZE_8BIT, (uint8_t[]) {0x01}, 1);

    // enable interrupt write register 0x07 -> 0x80
    HAL_I2C_Mem_Write_DMA(&HDC2010_I2C_PORT, HDC2010_ADDR, HDC2010_INT_MASK, I2C_MEMADD_SIZE_8BIT, (uint8_t[]) {0x80}, 1);
}
...
void hdc2010_read_temperature_humidity(float *temperature, float *humidity) {
    ...
    HAL_I2C_Mem_Read_DMA(&HDC2010_I2C_PORT, HDC2010_ADDR, HDC2010_TEMP_LOW, I2C_MEMADD_SIZE_8BIT, data, 4);
